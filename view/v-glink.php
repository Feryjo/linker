...
<body style="background: #1a1b1f;">
                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5" style="border: none;border-radius: 449px;">
                        <div class="card-body p-sm-5" style="background: #313133;border-color: #313133;">
                            <h2 class="text-center mb-4" style="color: #2e49f7;">Your Link</h2>
                            <form>
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="name"  value="<?= $link ?>" placeholder="Your Link" style="background: #414244;border-style: none;border-color: #414244;color:#b3b4b6"></div>
                                <div class="mb-3"></div>
                                <div class="mb-3"></div>
                                <div><button class="btn btn-primary text-center d-block w-100" type="button" onclick="myFunction()"><i class="far fa-copy" style="margin-bottom: 0px;margin-right: 3px;padding: 0px;"></i>Copy</button></div>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function myFunction() {
        /* Get the text field */
        var copyText = document.getElementById("name-2");
